...
**Issa の予測**（2026-09-17・登録 commit 469327c の後、本走の前にチャットの選択式で記入）: 主 **REMAINDER_REDUCED_BY_HOLD**、並び **NEFF_TRACKS**、傾き **SLOPE_POSITIVE**。ラベルだけを記録し、Issa 自身の確率は付けない。Claude の最頻ラベルと一致。
