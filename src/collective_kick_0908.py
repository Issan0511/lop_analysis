"""Minority-kick collective-response pilot. See specs/spec_collective_kick_0908.md."""
...
OUT=ROOT/'results/collective_kick_0908'
CONDS=['free_sham','global_plus','global_minus','pulse_plus','pulse_minus',
       'hold_sham','hold_plus','hold_minus','readout_sham','readout_plus','readout_minus']
def apg(z,act,a):
...
def main():
 ...
 meta={'models':reports,'wall_seconds':time.monotonic()-start,'source_sha256':hashlib.sha256((ROOT/'src/nets.py').read_bytes()).hexdigest(),
       'spec_sha256':hashlib.sha256((ROOT/'specs/spec_collective_kick_0908.md').read_bytes()).hexdigest(),
