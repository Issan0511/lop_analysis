...
def main():
 ...
 for ax,(arm,iv) in zip(axs.flat,ARMS):
  ...
  ax.set_xscale('symlog',linthresh=1);ax.set_xticks([-1,0,1,10,100,625],['pre','0','1','10','100','625']);ax.set_xlim(-1.3,720)
 ...
 for ax,(arm,iv) in zip(axs.flat,ARMS):
  ...
  ax.set_xscale('symlog',linthresh=1);ax.set_xticks([0,1,10,100,625],['0','1','10','100','625']);ax.set_xlim(0,720)
