...
OUT=ROOT/'results/unit_fates_0913/group_ablation_0914'
def main():
 OUT.mkdir(exist_ok=True)
 paths=[DATA/'ckpts'/f'SN_peak_q0_step{s}.pt' for s in [0,200000,1000000,5000000]]
 ...
 for step in [200000,1000000,5000000]:
  ...
  for ri in range(10):
   with np.load(DATA/'logs'/f'SN_peak_q0_seed{ri}.npz') as log:
