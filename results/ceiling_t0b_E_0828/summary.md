...
腕E（exploratory (existing std seeds)）。凍結 spec: vault `b44078c` `可塑性喪失/spec/天井T0b_spec_0828.md`。
...
- **T0b_window: EXPLORATORY_H_POSITIVE**
...
本腕は**探索**である（spec §8.1）。判定語の `EXPLORATORY_` 接頭辞はこの格を示す。論文の主張の根拠に単独で使わない。
