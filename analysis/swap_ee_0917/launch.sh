#!/usr/bin/env bash
# swap_ee_0917 -- spec section 8: 10 jobs (one per seed: two prefixes + 14 arms), 1 thread each, at most
# MAX_SLOTS at once.
...
#   setsid nohup bash analysis/swap_ee_0917/launch.sh > results/swap_ee_0917/logs/launch.log 2>&1 &
set -euo pipefail
cd "$(dirname "$0")/../.."
OUT=results/swap_ee_0917
MOD=src/swap_ee_0917.py
PY=/usr/bin/python3
...
[ -z "$(git status --porcelain -- src analysis/swap_ee_0917 specs/spec_swap_ee_0917.md)" ] \
