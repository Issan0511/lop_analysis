"""sgd_bridge_mnist_0914 resources (spec §8, §11-3): ONE 120-task run of the heaviest arm
(P06 seed 0, extras on) into results/_smoke_sgd_bridge_mnist_0914/resources/run, sampling the
...
ROOT = HERE.parents[1]
OUT = ROOT / 'results/_smoke_sgd_bridge_mnist_0914/resources'
...
def main():
    ...
    t0 = time.time()
    p = subprocess.Popen([sys.executable, '-m', 'src.sgd_bridge_mnist_0914', '--arm', 'P06', '--seed', '0', '--tasks', '120',
