...
def write_summary(
    ...
    lines = [
        ...
        f"- centered 最終の方向正規化 W 主軸 q(e1U): 全unit {_mean(seed_df, 'centered', FINAL_STEP, 'e1U_all_top_proj'):.4f}、alive {_mean(seed_df, 'centered', FINAL_STEP, 'e1U_alive_top_proj'):.4f}。",
        f"- std 最終の方向正規化 W 主軸 q(e1U): 全unit {_mean(seed_df, 'std', FINAL_STEP, 'e1U_all_top_proj'):.4f}、alive {_mean(seed_df, 'std', FINAL_STEP, 'e1U_alive_top_proj'):.4f}。",
        "",
