...
from .model import activations, make_model, prepare_noise, train_forward, update_adaptive
...
def main():
    ...
    atomic_json(REPO / 'results/joudaki_vit_battle_0919/speed_checks.json', dict(rows=rows, all_pass=all(r['pass'] for r in rows)))
